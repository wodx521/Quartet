...
public class UiTools {
        ...
        try {
            ...
            if (number instanceof Double) {
                ...
                if (noEmpty((String) number)) {
                    String replace = ((String) number).contains(",") ? ((String) number).replace(",", "") : (String) number;
    ...
    public static String formatLongTime(long milliSecond) {
        return simpleDateFormat.format(new Date(milliSecond));
    }

    public static String formatLongTime(long milliSecond, String pattern) {
